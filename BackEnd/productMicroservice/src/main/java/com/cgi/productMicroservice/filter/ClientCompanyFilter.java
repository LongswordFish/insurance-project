package com.cgi.productMicroservice.filter;
...
public class ClientCompanyFilter extends GenericFilter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
            throws IOException, ServletException {
                ...
                if (httprequest.getMethod().equals(HttpMethod.OPTIONS.name())) {
                    ...
                    try {
                        JwtParser jwtparser = Jwts.parser().setSigningKey("CgiInsuranceSecretKey".getBytes());
                        ...
                        if(role==null || !(role.equals("client")||role.equals("company"))){
